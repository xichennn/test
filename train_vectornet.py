...
def train(n_gpu, args):
    ...
    dataset_input_path = os.path.join(os.path.dirname(__file__), args.data_root)
    train_set = CarlaInMem(pjoin(dataset_input_path, "train"))
    eval_set = CarlaInMem(pjoin(dataset_input_path, "val"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data_root", required=False, type=str, default="../scene_mining_intermediate/",
